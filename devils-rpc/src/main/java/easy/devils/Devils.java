...
public class Devils {
    ...
    public static <T> T newProxyInstance(Class<T> interfaceClass,AbstractServiceDiscovery discovery){
        return DevilsDynamicProxy.newProxyInstance(interfaceClass,null,discovery,new FailoverCheckManager());
    }
