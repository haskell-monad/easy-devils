...
import easy.devils.client.cluster.loadbalance.PollLoadBalanceImpl;
...
import easy.devils.client.cluster.loadbalance.RobbinLoadBalanceImpl;
import easy.devils.client.cluster.loadbalance.WeightLoadBalanceImpl;
...
public class ClusterBuilder {
    ...
    public static AbstractLoadBalance builderLoadBalance(LoadBalanceType loadBalanceType,
        ...
        switch (loadBalanceType){
            ...
            case WEIGHT:
                return new WeightLoadBalanceImpl<>(serviceDiscovery,serviceName,checkManager);
            case WEIGHT_RANDOM:
