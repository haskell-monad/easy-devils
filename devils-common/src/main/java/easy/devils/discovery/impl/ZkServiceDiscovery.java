...
import easy.devils.protocol.MetaData;
 ...
 * @create 2017/11/18
 */
public class ZkServiceDiscovery extends AbstractServiceDiscovery<MetaData> implements TreeCacheListener{
     ...
     * zk元数据序列化
     */
    private static final InstanceSerializer instanceSerializer = new JsonInstanceSerializer<>(MetaData.class);
    ...
    @Override
    public void registerService(ServiceInstance<MetaData> serviceInstance) throws Exception {
        serviceDiscovery.registerService(serviceInstance);
    }

    @Override
    public void unregisterService(ServiceInstance<MetaData> serviceInstance) throws Exception {
        serviceDiscovery.unregisterService(serviceInstance);
    }

    @Override
    public void updateService(ServiceInstance<MetaData> serviceInstance) throws Exception {
    ...
    @Override
    public Collection<ServiceInstance<MetaData>> queryServiceInstance(String serviceName) throws Exception {
        return serviceDiscovery.queryForInstances(serviceName);
    }

    @Override
    public ServiceInstance<MetaData> queryServiceInstance(String serviceName, String instanceId) throws Exception {
